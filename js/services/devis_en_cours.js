...
/** ************************************************************************************************************** */
const pageTitle = 'Devis en cours';
...
const getIncidentsList = (year = 0) =>
  new Promise(function(resolve, reject) {
    fetch(
      `http://10.1.2.7:3100/requests/devisList/0/${year}/${capitalref}/${ownerref}/${clientref}`
    ).then(response => {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          createdCell(td, cellData, rowData, row, col) {
            ...
            if (rowData.Statut_du_devis__c == 'Accepté') {
        ...
        },
        {
          ...
          createdCell(td, cellData, rowData, row, col) {
            ...
            if (
              rowData.GTR == 1 &&
              (rowData.Statut_du_devis__c == 'Accepté') == 1 &&
              rowData.tempsGTR < 20
            ) {
              $(td).css('background', '#33691E');
              $(td).css('color', '#ffffff');
