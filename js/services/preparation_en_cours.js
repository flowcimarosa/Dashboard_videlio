...
/** ************************************************************************************************************** */
const pageTitle = 'Préparation en cours';
...
const getIncidentsList = (year = 0) =>
  new Promise(function(resolve, reject) {
    fetch(
      `http://10.1.2.7:3100/requests/preparationlist/0/${year}/${capitalref}/${ownerref}/${clientref}`
    ).then(response => {
